(function () {
    const THEMES = [
        { id: "default", name: "Dark Mode", description: "Original dark workspace with gold accents.", file: null },
        { id: "light", name: "Light Mode", description: "Bright, clean layout for daytime use.", file: "themes/light.css" }
    ];
